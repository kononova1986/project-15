...
// let currentIndex = 0;
// const projectsPerPege = 3;

// function loadProjects () {
//     const projectListEl = document.querySelector('.project-list');
//     const projectsToLoad = projects.slice(currentIndex, currentIndex+projectsPerPege);
...
//                                             <a href="${link}" class="project-link">VISIT
